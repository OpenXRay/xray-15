...
#define MAXVER_INTERNALNAME "wsd\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "wsd.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "WSD image I/O (plugin)\0"//should  be overidden on a per-dll level
