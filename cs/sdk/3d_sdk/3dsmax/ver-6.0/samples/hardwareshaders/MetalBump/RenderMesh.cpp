...
bool RenderMesh::Render(IDirect3DDevice8 *Device)
{
	if(m_Valid && Device && m_VB && m_IB)
	{
		Device->SetStreamSource(0,m_VB,sizeof(SHADERVERTEX));
		Device->SetIndices(m_IB,0L);
		Device->DrawIndexedPrimitive(D3DPT_TRIANGLELIST,0,m_NumVert,0,m_NumFace);
