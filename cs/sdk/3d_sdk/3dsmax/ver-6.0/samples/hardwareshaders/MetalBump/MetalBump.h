...
class MaxShader : public ReferenceTarget, public IDXDataBridge, TimeChangeCallback {
...
class MaxPixelShader: public IDX8PixelShader 
{
...
public :
	...
	DWORD GetPixelShaderHandle(int numPass) { return NULL; }
...
class MaxVertexShader : public IDX8VertexShader, public IStdDualVSCallback
{
...
public:
	...
	bool					CanTryStrips();
	int						GetNumMultiPass();
	DWORD					GetVertexShaderHandle(int numPass) { return 0; }
...
class DefaultClassDesc:public ClassDesc2 
{
	...
	const TCHAR*	InternalName()				 { return(_T("Metal Bump")); }	
