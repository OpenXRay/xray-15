...
#define MAXVER_INTERNALNAME "MetalBump\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MetalBump.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Metal Bump Viewport Effect\0"//should  be overidden on a per-dll level
