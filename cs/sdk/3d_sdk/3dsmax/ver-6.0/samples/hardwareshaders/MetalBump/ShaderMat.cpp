...
void ShaderMat::ReLoadAll(LPDIRECT3DDEVICE8 Device)
{
	int i;
...
void ShaderMat::SetChannelsSpecular(LPDIRECT3DDEVICE8 Device)
{
...
void ShaderMat::SetChannelsLight(LPDIRECT3DDEVICE8 Device)
{
...
void ShaderMat::SetChannelsMat(LPDIRECT3DDEVICE8 Device)
{
	int		i,Num,Index;
...
bool ShaderMat::Evaluate(float Time, LPDIRECT3DDEVICE8 Device, RenderMesh *RMesh)
{
	...
	{
		Device->SetPixelShaderConstant(CP_MIX_AMT,&D3DXVECTOR4(m_MixScale,
															   m_MixScale,
															   m_MixScale,
															   m_MixScale),1);

		Device->SetPixelShaderConstant(CP_REFLECT_AMT,&D3DXVECTOR4(m_ReflectScale,
																   m_ReflectScale,
																   m_ReflectScale,
																   m_ReflectScale),1);
	}
