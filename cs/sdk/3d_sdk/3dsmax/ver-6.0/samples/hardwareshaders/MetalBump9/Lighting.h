...
class Lighting
{
	public:
		...
		LPDIRECT3DVERTEXSHADER9	m_VertexHandle[SHADER_LIGHT_MAX];

		TSTR    				m_PixelFile[SHADER_LIGHT_MAX];
		unsigned long			m_PixelRes[SHADER_LIGHT_MAX];
		LPDIRECT3DPIXELSHADER9	m_PixelHandle[SHADER_LIGHT_MAX];
		...
		LPDIRECT3DCUBETEXTURE9	m_CubeNormal;
		bool					m_Ready;
		...
		bool	EvaluateAmbient(LPDIRECT3DDEVICE9 Device, RenderMesh *RMesh, ShaderMat *Mat);
		bool	EvaluateLighting(LPDIRECT3DDEVICE9 Device, RenderMesh *RMesh, ShaderMat *Mat);
		bool	EvaluateSpecular(LPDIRECT3DDEVICE9 Device, RenderMesh *RMesh, ShaderMat *Mat);
		bool	ClearAlpha(LPDIRECT3DDEVICE9 Device, RenderMesh *RMesh, ShaderMat *Mat);
	...
	private:
		...
		void	SetAttenMap();
		void	SetSpotMap();
		bool	LoadAttenTexture(TSTR &Name, LPDIRECT3DDEVICE9 Device);
		bool	LoadSpotTexture(TSTR &Name, LPDIRECT3DDEVICE9 Device);
		bool    CreateNormalizationCubeMap(LPDIRECT3DDEVICE9 Device, unsigned long Size);
