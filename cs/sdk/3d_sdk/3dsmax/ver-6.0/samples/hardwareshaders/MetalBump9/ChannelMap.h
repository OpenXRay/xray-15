...
class ChannelMap
{
	public:
		...
		IDirect3DBaseTexture9  *m_Texture;				// Texture
		bool					m_On;					// Use
		...
		//	Texture
		//
		bool					LoadTexture(LPDIRECT3DDEVICE9 Device);
		void					UnLoadTexture();
		bool					IsLoaded();
		IDirect3DBaseTexture9*	GetTexture();
		void					SetTexture(LPDIRECT3DDEVICE9 Device, bool AlphaOn = false);
	...
	private:
		...
		bool					LoadSingleTexture(LPDIRECT3DDEVICE9 Device, bool MipMap = true);
		bool					LoadSpecTexture(LPDIRECT3DDEVICE9 Device);
		bool					LoadCubeTexture(LPDIRECT3DDEVICE9 Device);
		bool					LoadBumpTexture(LPDIRECT3DDEVICE9 Device);
		bool					LoadNormalTexture(LPDIRECT3DDEVICE9 Device);
		bool					ConvertToBias(LPDIRECT3DDEVICE9 Device, LPDIRECT3DTEXTURE9 Source);
