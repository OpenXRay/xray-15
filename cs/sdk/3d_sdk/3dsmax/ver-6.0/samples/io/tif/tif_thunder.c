...
ThunderDecode(TIFF* tif, tidata_t op, tsize_t maxpixels)
{
	...
	if (npixels != maxpixels) {
		TIFFError(tif->tif_name,
		    GetString(IDS_THUNDER_BAD_DATA),//"ThunderDecode: %s data at scanline %ld (%lu != %lu)",
		    npixels < maxpixels ? GetString(IDS_THUNDER_NOT_EN)/*"Not enough"*/ : GetString(IDS_THUNDER_TOO_MUCH)/*"Too much"*/,
