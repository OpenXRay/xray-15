...
/* Geotiff support for VIZ */
#ifndef GEOREFSYS_UVW_MAPPING 
	#define	FIELD_CODEC			62	/* base of codec-private tags */
#else
	#define FIELD_MODELPIXELSCALE	62
	#define FIELD_MATRIX			63
	#define FIELD_MODELTIES			64
	#define FIELD_MODELTRANS		65
	#define FIELD_GEOKEYDIR			66
	#define FIELD_GEODOUBLE			67
	#define FIELD_GEOASCII			68
	#define	FIELD_CODEC				69	/* base of codec-private tags */
#endif
