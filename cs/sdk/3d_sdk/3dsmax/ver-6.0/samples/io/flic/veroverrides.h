...
#define MAXVER_INTERNALNAME "flic\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "flic.bmi\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "FLI/FLC file I/O (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: tom.hudson\0"//should  be overidden on a per-dll level
