/*
 * heteroterrain.h - data structure for heteroterrain instance
 */
...
/*
 * This is the heteroterrain instance data structure. An instance is a particular
 ...
 */
typedef struct st_HeteroTerrain {
...
int HeteroTerrainActivate(long, GlobalFunc *, LWTextureHandler *, void *);
int HeteroTerrainInterface(long, GlobalFunc *, LWInterface *, void *);
