...
//Name: materialShaders_basic.ma
//Last modified: Wed, Feb 04, 2004 06:25:08 PM
...
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 0.12783331 0 1 ;
	setAttr ".us" no;
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 0 0 10 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 1 0.12191997 0.10399997 ;
...
createNode mib_illum_lambert -n "mib_illum_lambert1";
	setAttr ".S02" -type "float3" 0.83399999 0.83399999 0.83399999 ;
createNode shadingEngine -n "mib_illum_lambert1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
connectAttr "mib_illum_lambert1SG.msg" "lightLinker1.lnk[2].olnk";
...
connectAttr "mib_illum_lambert1.msg" "mib_illum_lambert1SG.mims";
connectAttr "nurbsSphereShape1.iog" "mib_illum_lambert1SG.dsm" -na;
connectAttr "mib_illum_lambert1SG.msg" "materialInfo1.sg";
connectAttr "mib_illum_lambert1SG.pa" ":renderPartition.st" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "pointLightShape1.ltd" ":lightList1.l" -na;
connectAttr "directionalLightShape1.ltd" ":lightList1.l" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
connectAttr "directionalLight1.iog" ":defaultLightSet.dsm" -na;
// End of materialShaders_basic.ma
