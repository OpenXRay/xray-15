...
//Name: textureShaders_bump_finish.ma
//Last modified: Thu, Feb 05, 2004 01:51:36 PM
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.8715068284365648 2.0345138095939639 1.7704940438510222 ;
	setAttr ".r" -type "double3" -32.738352729585976 423.80000000001161 -3.60193943223338e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".coi" 1.3979711004403201;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.28845493463977512 1.4422746731988727 100 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100;
	setAttr ".ow" 5.3844921132757912;
...
createNode transform -n "nurbsPlane1";
	setAttr ".t" -type "double3" 0 -0.8679533989072824 0 ;
createNode nurbsSurface -n "nurbsPlaneShape1" -p "nurbsPlane1";
	...
	setAttr ".cc" -type "nurbsSurface" 
		...
		16
		-5 -1.4163847244119948e-015 5
		-5 -4.7212824147066497e-016 1.6666666666666665
		-5 4.7212824147066507e-016 -1.666666666666667
		-5 1.4163847244119948e-015 -5
		-1.6666666666666665 -1.4163847244119948e-015 5
		-1.6666666666666665 -4.7212824147066497e-016 1.6666666666666665
		-1.6666666666666665 4.7212824147066507e-016 -1.666666666666667
		-1.6666666666666665 1.4163847244119948e-015 -5
		1.666666666666667 -1.4163847244119948e-015 5
		1.666666666666667 -4.7212824147066497e-016 1.6666666666666665
		1.666666666666667 4.7212824147066507e-016 -1.666666666666667
		1.666666666666667 1.4163847244119948e-015 -5
		5 -1.4163847244119948e-015 5
		5 -4.7212824147066497e-016 1.6666666666666665
		5 4.7212824147066507e-016 -1.666666666666667
...
createNode transform -n "spotLight1";
	setAttr ".t" -type "double3" -0.39853093346697399 2.8848342445238817 3.6660043595762239 ;
	setAttr ".r" -type "double3" -46.246672866678026 0 0 ;
createNode spotLight -n "spotLightShape1" -p "spotLight1";
	setAttr -k off ".v";
	setAttr ".ca" 85.631729577951319;
	setAttr ".pa" 2.8156;
createNode transform -n "nurbsSphere2";
	setAttr ".t" -type "double3" -0.3748028267064254 0.43881080545817963 0.89622957264573988 ;
	setAttr ".s" -type "double3" 0.63016679193618286 0.63016679193618286 0.63016679193618286 ;
createNode nurbsSurface -n "nurbsSphereShape2" -p "nurbsSphere2";
	...
	setAttr ".cc" -type "nurbsSurface" 
		...
		54
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		...
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		4.6583697599767186e-017 -1 -5.1091989182730285e-016
		0.19999999999999976 -0.99999999999999978 -0.34641016151377613
		0.40000000000000024 -0.99999999999999989 -2.5824794853994925e-016
		0.20000000000000015 -1 0.34641016151377529
		-0.1999999999999999 -1 0.34641016151377546
		-0.40000000000000019 -0.99999999999999989 -9.6091435997019124e-017
		-0.20000000000000034 -0.99999999999999978 -0.34641016151377579
		0.19999999999999976 -0.99999999999999978 -0.34641016151377613
		0.40000000000000024 -0.99999999999999989 -2.5824794853994925e-016
		0.20000000000000015 -1 0.34641016151377529
		0.62615365636088349 -0.59999999999999964 -1.0845299461620761
		1.2523073127217688 -0.59999999999999998 9.4351657486626754e-017
		0.62615365636088427 -0.60000000000000031 1.0845299461620745
		-0.62615365636088394 -0.60000000000000031 1.084529946162075
		-1.2523073127217685 -0.59999999999999998 2.3011045056060136e-016
		-0.62615365636088482 -0.59999999999999964 -1.0845299461620748
		0.62615365636088349 -0.59999999999999964 -1.0845299461620761
		1.2523073127217688 -0.59999999999999998 9.4351657486626754e-017
		0.62615365636088427 -0.60000000000000031 1.0845299461620745
		0.62615365636088371 0.60000000000000053 -1.0845299461620759
		1.252307312721769 0.6000000000000002 5.2245856088411505e-016
		0.62615365636088427 0.59999999999999987 1.0845299461620752
		-0.62615365636088416 0.59999999999999987 1.0845299461620757
		-1.2523073127217688 0.6000000000000002 4.8186821488087087e-016
		-0.62615365636088494 0.60000000000000053 -1.0845299461620745
		0.62615365636088371 0.60000000000000053 -1.0845299461620759
		1.252307312721769 0.6000000000000002 5.2245856088411505e-016
		0.62615365636088427 0.59999999999999987 1.0845299461620752
		0.1999999999999999 1 -0.34641016151377552
		0.40000000000000024 1 4.5526355712253102e-016
		0.20000000000000001 0.99999999999999989 0.3464101615137759
		-0.20000000000000004 0.99999999999999989 0.34641016151377596
		-0.40000000000000019 1 3.2350483787009641e-016
		-0.20000000000000021 1 -0.34641016151377529
		0.1999999999999999 1 -0.34641016151377552
		0.40000000000000024 1 4.5526355712253102e-016
		0.20000000000000001 0.99999999999999989 0.3464101615137759
		1.9342856404284714e-016 1 9.520646022277922e-017
		1.9342856404284714e-016 1 9.520646022277922e-017
		1.9342856404284714e-016 1 9.520646022277922e-017
		1.9342856404284714e-016 1 9.520646022277922e-017
		1.9342856404284714e-016 1 9.520646022277922e-017
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\t\t\t-image \"\"\n"
		+ "\t\t\t\t-sc false\n"
		+ "\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 39 49 -ps 2 61 49 -ps 3 61 51 -ps 4 39 51 $gMainPane;\"\n"
		+ "\t\t\t\t-removeAllPanels\n"
		+ "\t\t\t\t-ap false\n"
		+ "\t\t\t\t\t\"Web Browser\"\n"
		+ "\t\t\t\t\t\"scriptedPanel\"\n"
		...
		+ "\t}\n"
		+ "grid -spacing 1 -size 10 -divisions 20 -displayAxes yes -displayGridLines yes -displayDivisionLines yes -displayPerspectiveLabels no -displayOrthographicLabels no -displayAxesBold yes -perspectiveLabelPosition axis -orthographicLabelPosition edge;\n"
		+ "}\n");
	setAttr ".st" 3;
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 376 -ast 0 -aet 500 ";
	setAttr ".st" 6;
createNode phong -n "ballMat_sw";
	setAttr ".c" -type "float3" 0.5 0.47522524 0.3845 ;
createNode shadingEngine -n "ballSG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo5";
createNode phong -n "floorMat_sw";
	setAttr ".c" -type "float3" 0.39450002 0.3962056 0.5 ;
...
createNode mentalrayOptions -s -n "Production";
	...
	setAttr ".rfrr" 10;
	setAttr ".maxr" 20;
createNode dgs_material -n "floorMat";
	setAttr ".S00" -type "float3" 0.396 0.39500001 0.5 ;
	setAttr ".S01" -type "float3" 0.050000001 0.050000001 0.050000001 ;
	setAttr ".S02" -type "float3" 0.1 0.1 0.1 ;
	setAttr ".S03" 0.10000000149011612;
createNode dgs_material -n "ballMat";
	setAttr ".S00" -type "float3" 0.5 0.47499999 0.384 ;
	setAttr ".S03" 0.20000000298023224;
createNode mib_passthrough_bump_map -n "mib_passthrough_bump_map1";
	setAttr ".S04" 8;
createNode mib_bump_basis -n "mib_bump_basis1";
...
createNode mib_color_mix -n "mib_color_mix1";
	setAttr ".S00" 1;
	setAttr ".S01" 1;
select -ne :time1;
	setAttr ".o" 0;
...
connectAttr "physical_light1.msg" "spotLightShape1.mils";
...
connectAttr "ballSG.msg" "lightLinker1.lnk[7].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[8].llnk";
connectAttr "floorSG.msg" "lightLinker1.lnk[8].olnk";
...
connectAttr "ballMat_sw.oc" "ballSG.ss";
connectAttr "nurbsSphereShape2.iog" "ballSG.dsm" -na;
connectAttr "ballMat.msg" "ballSG.mims";
connectAttr "ballSG.msg" "materialInfo5.sg";
connectAttr "ballMat_sw.msg" "materialInfo5.m";
connectAttr "floorMat_sw.oc" "floorSG.ss";
connectAttr "nurbsPlaneShape1.iog" "floorSG.dsm" -na;
connectAttr "floorMat.msg" "floorSG.mims";
connectAttr "floorSG.msg" "materialInfo6.sg";
connectAttr "floorMat_sw.msg" "materialInfo6.m";
connectAttr "mib_color_mix1.S26" "ballMat.S02";
connectAttr "mib_bump_basis1.S02" "mib_passthrough_bump_map1.S00";
connectAttr "mib_bump_basis1.S03" "mib_passthrough_bump_map1.S01";
connectAttr "mib_texture_remap1.S12" "mib_passthrough_bump_map1.S02";
connectAttr "mentalrayTexture1.msg" "mib_passthrough_bump_map1.s08";
connectAttr "mib_texture_vector1.S04" "mib_texture_remap1.S00";
connectAttr "mib_passthrough_bump_map1.S10" "mib_color_mix1.S25";
connectAttr "phong2SG.pa" ":renderPartition.st" -na;
connectAttr "ballSG.pa" ":renderPartition.st" -na;
connectAttr "floorSG.pa" ":renderPartition.st" -na;
connectAttr "ballMat_sw.msg" ":defaultShaderList1.s" -na;
connectAttr "floorMat_sw.msg" ":defaultShaderList1.s" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "physical_light1.msg" ":lightList1.l" -na;
connectAttr "spotLightShape1.ltd" ":lightList1.l" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
connectAttr "spotLight1.iog" ":defaultLightSet.dsm" -na;
// End of textureShaders_bump_finish.ma
