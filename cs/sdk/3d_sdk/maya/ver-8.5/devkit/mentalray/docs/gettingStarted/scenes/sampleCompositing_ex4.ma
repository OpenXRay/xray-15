//Maya ASCII 6.0ff07 (Beta 1) scene
//Name: sampleCompositing_ex4.ma
//Last modified: Sun, Nov 30, 2003 08:06:01 PM
requires maya "6.0ff07 (Beta 1)";
requires "Mayatomr" "6.0.1.0m - 3.3.0.464 ";
requires "VectorRender" "6.0 - 3.126 - cut 200311280225";
currentUnit -l centimeter -a degree -t film;
fileInfo "application" "maya";
fileInfo "product" "Maya Unlimited 6.0 Beta";
fileInfo "version" "6.0Mainline";
fileInfo "cutIdentifier" "200311280105-606562";
fileInfo "osv" "Microsoft Windows XP Service Pack 1 (Build 2600)\n";
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.25551791047024475 10.730604898170093 24.399271167732113 ;
	setAttr ".r" -type "double3" -23.738352729615585 -0.59999999999733589 0 ;
createNode camera -s -n "perspShape" -p "persp";
	addAttr -ci true -sn "mios" -ln "miOutputShader" -bt "UNKN" -at "message";
	addAttr -ci true -sn "micc" -ln "miFbComputeColor" -bt "UNKN" -dv 1 -min 
		0 -max 1 -at "bool";
	addAttr -ci true -sn "mict" -ln "miFbBitsizeColor" -bt "UNKN" -at "short";
	addAttr -ci true -sn "mica" -ln "miFbComputeAlpha" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "miat" -ln "miFbBitsizeAlpha" -bt "UNKN" -at "short";
	addAttr -ci true -sn "micd" -ln "miFbComputeDepth" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "micn" -ln "miFbComputeNormal" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "micm" -ln "miFbComputeMotion" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "micv" -ln "miFbComputeCoverage" -bt "UNKN" -min 0 
		-max 1 -at "bool";
	addAttr -ci true -sn "mitg" -ln "miFbComputeTag" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "mico" -ln "miFbComputeContour" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "mivs" -ln "miVolumeShader" -bt "UNKN" -at "message";
	addAttr -ci true -sn "mils" -ln "miLensShader" -bt "UNKN" -at "message";
	addAttr -ci true -sn "mies" -ln "miEnvironmentShader" -bt "UNKN" -at "message";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 10000;
	setAttr ".coi" 26.65587373168843;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -8.8817841970012523e-016 0 0 ;
...
createNode checker -n "checker1";
	setAttr ".c2" -type "float3" 0.67500001 0.76499999 0.87199998 ;
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\t\t\t-image \"\"\n"
		+ "\t\t\t\t-sc false\n"
		+ "\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 53 49 -ps 2 47 49 -ps 3 47 51 -ps 4 53 51 $gMainPane;\"\n"
		+ "\t\t\t\t-removeAllPanels\n"
		+ "\t\t\t\t-ap true\n"
		+ "\t\t\t\t\t\"Web Browser\"\n"
		+ "\t\t\t\t\t\"scriptedPanel\"\n"
...
createNode makeNurbSphere -n "makeNurbSphere2";
	setAttr ".ax" -type "double3" 0 1 0 ;
createNode shadingEngine -n "mib_reflect1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
createNode shadingEngine -n "mib_reflect2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
createNode mib_reflect -n "mib_reflect1";
	setAttr ".S00" -type "float3" 0.5 0.5 0.5 ;
	setAttr ".S01" -type "float3" 0.5 0.5 0.5 ;
createNode mib_reflect -n "mib_reflect2";
	setAttr ".S00" -type "float3" 0.5 0.5 0.5 ;
	setAttr ".S01" -type "float3" 0.5 0.5 0.5 ;
	setAttr ".S02" yes;
createNode mib_lookup_spherical -n "mib_lookup_spherical1";
...
connectAttr "mib_lookup_spherical1.msg" ":perspShape.mies";
...
connectAttr "mib_reflect1SG.msg" "lightLinker1.lnk[11].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[12].llnk";
connectAttr "mib_reflect2SG.msg" "lightLinker1.lnk[12].olnk";
...
connectAttr "mib_reflect1.msg" "mib_reflect1SG.mims";
connectAttr "nurbsSphereShape1.iog" "mib_reflect1SG.dsm" -na;
connectAttr "mib_reflect1SG.msg" "materialInfo2.sg";
connectAttr "mib_reflect2.msg" "mib_reflect2SG.mims";
connectAttr "nurbsSphereShape2.iog" "mib_reflect2SG.dsm" -na;
connectAttr "mib_reflect2SG.msg" "materialInfo3.sg";
connectAttr "mentalrayTexture1.msg" "mib_lookup_spherical1.s02";
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "mib_reflect1SG.pa" ":renderPartition.st" -na;
connectAttr "mib_reflect2SG.pa" ":renderPartition.st" -na;
connectAttr "lambert2.msg" ":defaultShaderList1.s" -na;
connectAttr "mib_lookup_spherical1.msg" ":defaultShaderList1.s" -na;
connectAttr "place2dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "mib_reflect1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "mib_reflect2.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "directionalLightShape1.ltd" ":lightList1.l" -na;
connectAttr "checker1.msg" ":defaultTextureList1.tx" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
connectAttr "directionalLight1.iog" ":defaultLightSet.dsm" -na;
// End of sampleCompositing_ex4.ma
