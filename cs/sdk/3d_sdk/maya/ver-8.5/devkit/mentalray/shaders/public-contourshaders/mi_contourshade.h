...
/* The color of the contour is constant.  The width is random. */
DLLEXPORT int contour_shader_randomwidth_version(void);

DLLEXPORT miBoolean contour_shader_randomwidth(
    miContour_endpoint  *result,
    miStdInfo           *info_near,
    miStdInfo           *info_far,
    miState             *state,	   
...
/* The transparency of the contour is random.  The width is constant. */
DLLEXPORT int contour_shader_randomtransparency_version(void);

DLLEXPORT miBoolean contour_shader_randomtransparency(
    miContour_endpoint  *result,
    miStdInfo           *info_near,
    miStdInfo           *info_far,
    miState             *state,	   
