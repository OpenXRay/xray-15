...
typedef enum {
	...
	miIMG_TYPE_CONT		= 32,	/* API/PHEN: contours */
...
typedef struct miOptions {
	...
	miUint1		spare0[3];		/* not used */
	miTag		state_func;		/* allow user to init state */
	int		spare[13];		/* not used */
} miOptions;
...
#define miVFB_FIRST		16
#define miVFB_SAMPLE_TIME	16	/* time when sample was shot */
#define miVFB_SAMPLE_LIMITS	17	/* per object sample limits */
#define miVFB_TOTAL		18
