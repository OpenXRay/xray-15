...
//Name: phenomenon_create.ma
//Last modified: Mon, Feb 02, 2004 12:15:00 AM
...
createNode mentalrayPhenomenon -n "anisotropic_mtl";
	setAttr ".ama" yes;
	setAttr ".rdv" 1;
	setAttr -s 9 ".if";
	setAttr -s 9 ".pa";
	setAttr ".pa[0].pan" -type "string" "diffuse";
	setAttr ".pa[0].pat" 4;
	setAttr ".pa[1].pan" -type "string" "ambient";
	setAttr ".pa[1].pat" 4;
	setAttr ".pa[2].pan" -type "string" "shiny_u";
	setAttr ".pa[2].pat" 2;
	setAttr ".pa[3].pan" -type "string" "shiny_v";
	setAttr ".pa[3].pat" 2;
	setAttr ".pa[4].pan" -type "string" "spacing";
	setAttr ".pa[4].pat" 2;
	setAttr ".pa[5].pan" -type "string" "strength";
	setAttr ".pa[5].pat" 2;
	setAttr ".pa[6].pan" -type "string" "power";
	setAttr ".pa[6].pat" 2;
	setAttr ".pa[7].pan" -type "string" "iteration";
	setAttr ".pa[7].pat" 1;
	setAttr ".pa[8].pan" -type "string" "lights";
	setAttr ".pa[8].pat" 11;
	setAttr ".pa[8].paa" yes;
	setAttr ".re[0].ren" -type "string" "outValue";
	setAttr ".re[0].ret" 4;
select -ne :time1;
	setAttr ".o" 300;
...
connectAttr "anisotropic_mtl.if[0]" "mtl.S02";
connectAttr "anisotropic_mtl.if[1]" "mtl.S01";
connectAttr "anisotropic_mtl.if[2]" "mtl.S04";
connectAttr "anisotropic_mtl.if[3]" "mtl.S05";
connectAttr "anisotropic_mtl.if[8]" "mtl.S09[0]";
connectAttr "uderiv.S04" "rotate.S00";
connectAttr "tex.S06" "rotate.S01";
connectAttr "coord.S04" "tex.S00";
connectAttr "anisotropic_mtl.if[4]" "tex.S01";
connectAttr "anisotropic_mtl.if[5]" "tex.S02";
connectAttr "anisotropic_mtl.if[6]" "tex.S03";
connectAttr "anisotropic_mtl.if[7]" "tex.S04";
connectAttr "mtl.msg" "mtlSG.mims";
connectAttr "nurbsSphereShape1.iog" "mtlSG.dsm" -na;
connectAttr "mtlSG.msg" "materialInfo1.sg";
connectAttr "mtl.msg" "anisotropic_mtl.rt" -na;
