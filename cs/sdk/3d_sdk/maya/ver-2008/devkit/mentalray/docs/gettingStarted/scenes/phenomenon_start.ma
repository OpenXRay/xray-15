...
//Name: phenomenon_start.ma
//Last modified: Sun, Feb 01, 2004 10:21:48 PM
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.2099391761266127 2.2953759802914036 4.3926564755732134 ;
	setAttr ".r" -type "double3" -26.738352729602536 -15.399999999999965 -8.2475102243387132e-016 ;
	setAttr ".rp" -type "double3" 4.4408920985006262e-016 8.8817841970012523e-016 
		0 ;
	setAttr ".rpt" -type "double3" 9.3853509444830062e-017 -9.4972543235143598e-017 
		-2.5984264435481193e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".coi" 5.1017775934686487;
...
createNode transform -n "directionalLight1";
	setAttr ".r" -type "double3" -32.333572085282135 -45.822003692179408 -12.745786710484348 ;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr -s 25 ".uvst[0].uvsp[0:24]" -type "float2" 0 0 0.25 
		0 0.5 0 0.75 0 1 0 0 0.25 0.25 0.25 0.5 0.25 0.75 0.25 1 0.25 0 0.5 0.25 
		0.5 0.5 0.5 0.75 0.5 1 0.5 0 0.75 0.25 0.75 0.5 0.75 0.75 0.75 1 0.75 0 1 
		0.25 1 0.5 1 0.75 1 1 1;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr -s 25 ".vt[0:24]"  -0.5 -1.110223e-016 0.5 -0.25 -1.110223e-016 
		0.5 0 -1.110223e-016 0.5 0.25 -1.110223e-016 0.5 0.5 -1.110223e-016 0.5 -0.5 
		-5.5511151e-017 0.25 -0.25 -5.5511151e-017 0.25 0 -5.5511151e-017 0.25 0.25 
		-5.5511151e-017 0.25 0.5 -5.5511151e-017 0.25 -0.5 0 0 -0.25 0 0 0 0 0 0.25 
		0 0 0.5 0 0 -0.5 5.5511151e-017 -0.25 -0.25 5.5511151e-017 -0.25 0 5.5511151e-017 
		-0.25 0.25 5.5511151e-017 -0.25 0.5 5.5511151e-017 -0.25 -0.5 1.110223e-016 
		-0.5 -0.25 1.110223e-016 -0.5 0 1.110223e-016 -0.5 0.25 1.110223e-016 -0.5 
		0.5 1.110223e-016 -0.5;
	setAttr -s 40 ".ed[0:39]"  0 1 0 0 5 
		0 1 2 0 1 6 1 2 3 0 2 
		7 1 3 4 0 3 8 1 4 9 0 
		5 6 1 5 10 0 6 7 1 6 11 
		1 7 8 1 7 12 1 8 9 1 8 
		13 1 9 14 0 10 11 1 10 15 0 
		11 12 1 11 16 1 12 13 1 12 17 
		1 13 14 1 13 18 1 14 19 0 15 
		16 1 15 20 0 16 17 1 16 21 1 
		17 18 1 17 22 1 18 19 1 18 23 
		1 19 24 0 20 21 0 21 22 0 22 
		23 0 23 24 0;
...
createNode mentalrayOptions -s -n "ProductionMotionblur";
	...
	setAttr ".maxr" 20;
	setAttr ".mb" 2;
createNode mib_illum_ward -n "mtl";
	setAttr ".S00" -type "float3" 0.5 0.5 0.5 ;
	setAttr ".S01" -type "float3" 0.2 0.17 0.34 ;
	setAttr ".S02" -type "float3" 0.69999999 0.69999999 1 ;
	setAttr ".S03" -type "float3" 1 1 1 ;
	setAttr ".S04" 1;
	setAttr ".S05" 3;
createNode mib_texture_rotate -n "rotate";
createNode mib_texture_vector -n "uderiv";
	setAttr ".S00" -5;
	setAttr ".S03" 0;
createNode mib_texture_turbulence -n "tex";
	setAttr ".S01" 0.80000001192092896;
	setAttr ".S02" 5;
	setAttr ".S03" 3;
	setAttr ".S04" 2;
	setAttr ".S05" 1;
createNode mib_texture_vector -n "coord";
	setAttr ".S00" -1;
	setAttr ".S01" 2;
	setAttr ".S03" 0;
...
createNode mentalrayFramebuffer -s -n "miDefaultFramebuffer";
	setAttr ".w" 320;
	setAttr ".h" 240;
createNode shadingEngine -n "mtlSG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
connectAttr "mtlSG.msg" "lightLinker1.lnk[2].olnk";
...
connectAttr "rotate.S04" "mtl.S06";
connectAttr "rotate.S05" "mtl.S07";
connectAttr "uderiv.S04" "rotate.S00";
connectAttr "tex.S06" "rotate.S01";
connectAttr "coord.S04" "tex.S00";
connectAttr "mtl.msg" "mtlSG.mims";
connectAttr "nurbsSphereShape1.iog" "mtlSG.dsm" -na;
connectAttr "mtlSG.msg" "materialInfo1.sg";
connectAttr "mtlSG.pa" ":renderPartition.st" -na;
connectAttr "mtl.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "tex.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "directionalLightShape1.ltd" ":lightList1.l" -na;
connectAttr "rotate.msg" ":defaultTextureList1.tx" -na;
connectAttr "uderiv.msg" ":defaultTextureList1.tx" -na;
connectAttr "coord.msg" ":defaultTextureList1.tx" -na;
connectAttr "pPlaneShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "directionalLight1.iog" ":defaultLightSet.dsm" -na;
// End of phenomenon_start.ma
