...
//Name: photonVolume_finish.ma
//Last modified: Thu, Jan 22, 2004 11:16:31 PM
...
createNode nurbsSurface -n "backnurbsCubeShape1" -p "backnurbsCube1";
	...
	setAttr ".cpr" 4;
	setAttr ".cps" 4;
createNode transform -n "front_Sphere" -p "group1";
	...
	setAttr ".cst" 4;
	setAttr ".glb" 4;
createNode nurbsSurface -n "front_SphereShape" -p "front_Sphere";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".tw" yes;
...
createNode rectangularLightLocator -n "light_mrLoc" -p "light";
	setAttr -k off ".v";
createNode transform -n "backSphere" -p "group1";
	...
	setAttr ".cst" 4;
	setAttr ".glb" 4;
createNode nurbsSurface -n "backSphereShape" -p "backSphere";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".tw" yes;
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "                -showInvisible 0\n"
		+ "                -transitionFrames 5\n"
		+ "                -currentNode \"mirror_dgs_mat_photon\" \n"
		+ "                -freeform 0\n"
		+ "                -imageEnabled 0\n"
		+ "                -graphType \"DG\" \n"
		+ "                -updateSelection 1\n"
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".st" 6;
createNode dielectric_material -n "dielectric_material";
	setAttr ".S00" -type "float3" 0.99000001 0.99000001 0.995 ;
	setAttr ".S01" 1.75;
	setAttr ".S05" 0.5;
createNode dielectric_material_photon -n "dielectric_material_photon";
	setAttr ".S00" -type "float3" 0.99000001 0.99000001 0.995 ;
	setAttr ".S01" 1.75;
	setAttr ".S05" 0.5;
createNode dgs_material_photon -n "mirror_dgs_mat_photon";
	setAttr ".S02" -type "float3" 1 1 1 ;
	setAttr ".S03" 0.5;
createNode dgs_material -n "mirror_dgs_mat";
	setAttr ".S02" -type "float3" 1 1 1 ;
	setAttr ".S03" 0.5;
createNode physical_light -n "physical_light";
createNode dgs_material_photon -n "white_dgs_mat_photon";
...
createNode parti_volume -n "parti_volume1";
	...
	setAttr ".S09" 1;
	setAttr ".S10" 2;
createNode parti_volume_photon -n "parti_volume_photon1";
	setAttr ".S01" -type "float3" 0.050000001 0.050000001 0.050000001 ;
	setAttr ".S02" 0.05000000074505806;
	setAttr ".S08" 0.12999999523162842;
	setAttr ".S09" 1;
...
createNode transmat_photon -n "transmat_photon1";
createNode dgs_material_photon -n "dgs_material_photon1";
	setAttr ".S00" -type "float3" 0 0 0.80000001 ;
createNode dgs_material -n "dgs_material1";
	setAttr ".S00" -type "float3" 0 0 0.80000001 ;
createNode dgs_material -n "dgs_material2";
	setAttr ".S00" -type "float3" 0.80000001 0 0 ;
createNode dgs_material_photon -n "dgs_material_photon2";
	setAttr ".S00" -type "float3" 0.80000001 0 0 ;
...
connectAttr "makeNurbSphere1.os" "front_SphereShape.cr";
connectAttr "physical_light.S04" "lightShape.mils";
connectAttr "makeNurbSphere2.os" "backSphereShape.cr";
...
connectAttr "blinn4SG.msg" "lightLinker1.lnk[5].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[6].llnk";
connectAttr "blinn5SG.msg" "lightLinker1.lnk[6].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[7].llnk";
connectAttr "blinn6SG.msg" "lightLinker1.lnk[7].olnk";
...
connectAttr "volmat.oc" "blinn1SG.ss";
connectAttr "coverShape.iog" "blinn1SG.dsm" -na;
connectAttr "leftnurbsCubeShape1.iog" "blinn1SG.dsm" -na;
connectAttr "rightnurbsCubeShape1.iog" "blinn1SG.dsm" -na;
connectAttr "parti_volume1.S14" "blinn1SG.mivs";
connectAttr "parti_volume_photon1.S14" "blinn1SG.mipv";
connectAttr "transmat1.S00" "blinn1SG.mims";
connectAttr "transmat_photon1.S00" "blinn1SG.mips";
connectAttr "blinn1SG.msg" "materialInfo1.sg";
connectAttr "volmat.msg" "materialInfo1.m";
connectAttr "diffuse_red.oc" "blinn2SG.ss";
connectAttr "backnurbsCubeShape1.iog" "blinn2SG.dsm" -na;
connectAttr "dgs_material2.S09" "blinn2SG.mims";
connectAttr "dgs_material_photon2.S09" "blinn2SG.mips";
connectAttr "blinn2SG.msg" "materialInfo2.sg";
connectAttr "diffuse_red.msg" "materialInfo2.m";
connectAttr "diffuse_blue.oc" "blinn3SG.ss";
connectAttr "frontnurbsCubeShape1.iog" "blinn3SG.dsm" -na;
connectAttr "dgs_material_photon1.S09" "blinn3SG.mips";
connectAttr "dgs_material1.S09" "blinn3SG.mims";
connectAttr "blinn3SG.msg" "materialInfo3.sg";
connectAttr "diffuse_blue.msg" "materialInfo3.m";
connectAttr "diffuse_white1.oc" "blinn4SG.ss";
connectAttr "topnurbsCubeShape1.iog" "blinn4SG.dsm" -na;
connectAttr "bottomnurbsCubeShape1.iog" "blinn4SG.dsm" -na;
connectAttr "white_dgs_mat_photon.S09" "blinn4SG.mips";
connectAttr "white_dgs_mat.S09" "blinn4SG.mims";
connectAttr "blinn4SG.msg" "materialInfo4.sg";
connectAttr "diffuse_white1.msg" "materialInfo4.m";
connectAttr "mirror.oc" "blinn5SG.ss";
connectAttr "backSphereShape.iog" "blinn5SG.dsm" -na;
connectAttr "mirror_dgs_mat_photon.S09" "blinn5SG.mips";
connectAttr "mirror_dgs_mat.S09" "blinn5SG.mims";
connectAttr "blinn5SG.msg" "materialInfo5.sg";
connectAttr "mirror.msg" "materialInfo5.m";
connectAttr "glass.oc" "blinn6SG.ss";
connectAttr "front_SphereShape.iog" "blinn6SG.dsm" -na;
connectAttr "dielectric_material.S07" "blinn6SG.mims";
connectAttr "dielectric_material_photon.S07" "blinn6SG.mips";
connectAttr "blinn6SG.msg" "materialInfo6.sg";
connectAttr "glass.msg" "materialInfo6.m";
connectAttr "lightShape.msg" "dielectric_material.S06[0]";
connectAttr "lightShape.msg" "dielectric_material_photon.S06[0]";
connectAttr "lightShape.msg" "mirror_dgs_mat_photon.S08[0]";
connectAttr "lightShape.msg" "mirror_dgs_mat.S08[0]";
connectAttr "lightShape.msg" "white_dgs_mat_photon.S08[0]";
connectAttr "lightShape.msg" "white_dgs_mat.S08[0]";
connectAttr "lightShape.msg" "parti_volume1.S13[0]";
connectAttr "lightShape.msg" "parti_volume_photon1.S13[0]";
connectAttr "lightShape.msg" "dgs_material_photon1.S08[0]";
connectAttr "lightShape.msg" "dgs_material1.S08[0]";
connectAttr "lightShape.msg" "dgs_material2.S08[0]";
connectAttr "lightShape.msg" "dgs_material_photon2.S08[0]";
...
connectAttr "dielectric_material.msg" ":defaultShaderList1.s" -na;
connectAttr "mirror_dgs_mat.msg" ":defaultShaderList1.s" -na;
connectAttr "white_dgs_mat.msg" ":defaultShaderList1.s" -na;
connectAttr "parti_volume1.msg" ":defaultShaderList1.s" -na;
connectAttr "transmat1.msg" ":defaultShaderList1.s" -na;
connectAttr "dgs_material1.msg" ":defaultShaderList1.s" -na;
connectAttr "dgs_material2.msg" ":defaultShaderList1.s" -na;
connectAttr "dielectric_material_photon.msg" ":defaultRenderUtilityList1.u"
		 -na;
connectAttr "mirror_dgs_mat_photon.msg" ":defaultRenderUtilityList1.u" -na
		;
connectAttr "white_dgs_mat_photon.msg" ":defaultRenderUtilityList1.u" -na
		;
connectAttr "parti_volume_photon1.msg" ":defaultRenderUtilityList1.u" -na
		;
connectAttr "transmat_photon1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "dgs_material_photon1.msg" ":defaultRenderUtilityList1.u" -na
		;
connectAttr "dgs_material_photon2.msg" ":defaultRenderUtilityList1.u" -na
		;
connectAttr "light_mrLoc.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "lightShape.ltd" ":lightList1.l" -na;
connectAttr "physical_light.msg" ":lightList1.l" -na;
connectAttr "light.iog" ":defaultLightSet.dsm" -na;
connectAttr "physical_light.msg" ":defaultLightSet.dnsm" -na;
// End of photonVolume_finish.ma
