...
//Name: sampleCompositing_ex1.ma
//Last modified: Sun, Nov 30, 2003 07:29:53 PM
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.091524606233768457 7.5294413251676158 26.219761799875773 ;
	setAttr ".r" -type "double3" -3.338352729605885 0.20000000000216506 6.2120587082209088e-018 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".ncp" 0.001;
	setAttr ".fcp" 10000;
	setAttr ".coi" 26.264490788189722;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -8.8817841970012523e-016 6 0 ;
...
createNode transform -n "nurbsPlane1";
	setAttr ".s" -type "double3" 149.56812473922159 149.56812473922159 149.56812473922159 ;
...
createNode makeNurbSphere -n "makeNurbSphere2";
	setAttr ".ax" -type "double3" 0 1 0 ;
createNode mib_opacity -n "mib_opacity1";
	setAttr ".S00" -type "float3" 1 0.89999998 0.69999999 ;
	setAttr ".S01" -type "float3" 0.40000001 0.25 0.25 ;
createNode mib_transparency -n "mib_transparency1";
	setAttr ".S00" -type "float3" 1 0.89999998 0.69999999 ;
	setAttr ".S01" -type "float3" 0.60000002 0.75 0.75 ;
createNode shadingEngine -n "mib_opacity1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
createNode shadingEngine -n "mib_transparency1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
connectAttr "mib_opacity1SG.msg" "lightLinker1.lnk[11].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[12].llnk";
connectAttr "mib_transparency1SG.msg" "lightLinker1.lnk[12].olnk";
...
connectAttr "mib_opacity1.msg" "mib_opacity1SG.mims";
connectAttr "nurbsSphereShape1.iog" "mib_opacity1SG.dsm" -na;
connectAttr "mib_opacity1SG.msg" "materialInfo2.sg";
connectAttr "mib_transparency1.msg" "mib_transparency1SG.mims";
connectAttr "nurbsSphereShape2.iog" "mib_transparency1SG.dsm" -na;
connectAttr "mib_transparency1SG.msg" "materialInfo3.sg";
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "mib_opacity1SG.pa" ":renderPartition.st" -na;
connectAttr "mib_transparency1SG.pa" ":renderPartition.st" -na;
connectAttr "lambert2.msg" ":defaultShaderList1.s" -na;
connectAttr "place2dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "mib_opacity1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "mib_transparency1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "directionalLightShape1.ltd" ":lightList1.l" -na;
connectAttr "checker1.msg" ":defaultTextureList1.tx" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
connectAttr "directionalLight1.iog" ":defaultLightSet.dsm" -na;
// End of sampleCompositing_ex1.ma
