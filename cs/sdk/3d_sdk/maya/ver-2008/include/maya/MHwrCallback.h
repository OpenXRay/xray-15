...
// *****************************************************************************
//
// CLASS DESCRIPTION (MMwrCallback)
//
// This class is used to register callbacks to be notified in render device
// state, Created, Lost, Reset, Deleted.  
//
// To register callbacks, inherit from this class and override
// deviceNew(), deviceLost(), deviceReset() or deviceDeleted(). Any
