...
{	
	...
	m_pButtons[0]	= new CUI3tButtonEx();	m_pFrames->AttachChild(m_pButtons[0]); m_pButtons[0]->SetMessageTarget(this);
	m_pButtons[1]	= new CUI3tButtonEx();	m_pFrames->AttachChild(m_pButtons[1]); m_pButtons[1]->SetMessageTarget(this);

	m_pBtnAutoSelect= new CUI3tButtonEx();	AttachChild(m_pBtnAutoSelect);
	m_pBtnSpectator	= new CUI3tButtonEx();	AttachChild(m_pBtnSpectator);
	m_pBtnBack		= new CUI3tButtonEx();	AttachChild(m_pBtnBack);
