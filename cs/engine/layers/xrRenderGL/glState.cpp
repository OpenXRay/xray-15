...
void glState::UpdateSamplerState(u32 stage, u32 name, u32 value)
{
	...
	switch (name)
	{
		case D3DSAMP_ADDRESSU:			/* D3DTEXTUREADDRESS for U coordinate */
			CHK_GL(glSamplerParameteri(m_samplerArray[stage], GL_TEXTURE_WRAP_S, glStateUtils::ConvertTextureAddressMode(value)));
			break;
		case D3DSAMP_ADDRESSV:			/* D3DTEXTUREADDRESS for V coordinate */
			CHK_GL(glSamplerParameteri(m_samplerArray[stage], GL_TEXTURE_WRAP_T, glStateUtils::ConvertTextureAddressMode(value)));
			break;
		case D3DSAMP_ADDRESSW:			/* D3DTEXTUREADDRESS for W coordinate */
			CHK_GL(glSamplerParameteri(m_samplerArray[stage], GL_TEXTURE_WRAP_R, glStateUtils::ConvertTextureAddressMode(value)));
			break;
		...
		case D3DSAMP_MAGFILTER:			/* D3DTEXTUREFILTER filter to use for magnification */
			CHK_GL(glSamplerParameteri(m_samplerArray[stage], GL_TEXTURE_MAG_FILTER, glStateUtils::ConvertTextureFilter(value)));
			break;
		case D3DSAMP_MINFILTER:			/* D3DTEXTUREFILTER filter to use for minification */
			CHK_GL(glSamplerParameteri(m_samplerArray[stage], GL_TEXTURE_MIN_FILTER, glStateUtils::ConvertTextureFilter(value, currentFilter)));
			break;
		case D3DSAMP_MIPFILTER:			/* D3DTEXTUREFILTER filter to use between mipmaps during minification */
			CHK_GL(glSamplerParameteri(m_samplerArray[stage], GL_TEXTURE_MIN_FILTER, glStateUtils::ConvertTextureFilter(value, currentFilter, true)));
			break;
